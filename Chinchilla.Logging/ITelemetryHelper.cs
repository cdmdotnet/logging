...
namespace Chinchilla.Logging
{
	...
	public interface ITelemetryHelper
	{
		...
		/// <param name="wasSuccessfull">True if the request was handled successfully by the application.</param>
		/// <param name="properties">Named string values you can use to search and classify events.</param>
		void TrackProcessFlow(string name, TimeSpan duration, string responseCode, bool wasSuccessfull, string sequence = null, IDictionary<string, string> properties = null);
		...
		/// <param name="properties">Named string values you can use to search and classify events.</param>
		/// <param name="sessionId">The application-defined session ID.</param>
		void TrackProcessFlow(string name, Uri url, string userId, TimeSpan duration, string responseCode, bool wasSuccessfull, string sequence = null, IDictionary<string, string> properties = null, string sessionId = null);
