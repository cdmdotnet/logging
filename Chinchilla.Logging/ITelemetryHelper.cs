...
namespace Chinchilla.Logging
{
	...
	public interface ITelemetryHelper
	{
		...
		void TrackRequest(string name, Uri url, string userId, DateTimeOffset startTime, TimeSpan duration, string responseCode, bool wasSuccessfull, IDictionary<string, string> properties = null, string sessionId = null);
		...
		/// <param name="properties">Named string values you can use to search and classify events.</param>
		/// <param name="sessionId">The application-defined session ID</param>
		void TrackTrace(string message, int severityLevel = 1, IDictionary<string, string> properties = null, string sessionId = null);
		...
		/// <param name="properties">Named string values you can use to search and classify events.</param>
		/// <param name="sessionId">The application-defined session ID</param>
		void TrackTrace(string message, string userId, int severityLevel = 1, IDictionary<string, string> properties = null, string sessionId = null);
		...
		/// <param name="wasSuccessfull">True if the request was handled successfully by the application.</param>
		/// <param name="properties">Named string values you can use to search and classify events.</param>
		void TrackProcessFlow(string name, string processFlowStepType, string processFlowStepName, string processFlowHost, TimeSpan duration, string responseCode, bool wasSuccessfull, string sequence = null, IDictionary<string, string> properties = null);
		...
		/// <param name="properties">Named string values you can use to search and classify events.</param>
		/// <param name="sessionId">The application-defined session ID.</param>
		void TrackProcessFlow(string name, Uri url, string processFlowStepType, string processFlowStepName, string processFlowHost, string userId, TimeSpan duration, string responseCode, bool wasSuccessfull, string sequence = null, IDictionary<string, string> properties = null, string sessionId = null);
