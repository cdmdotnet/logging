...
namespace Chinchilla.Logging.Azure.ApplicationInsights
{
	...
	public class TelemetryHelper : ITelemetryHelper
	{
		...
		{
			TrackProcessFlow(name, new Uri(string.Format("//{0}", name)), processFlowStepType, processFlowStepName, processFlowHost, null, duration, responseCode, wasSuccessfull, sequence, properties);
		}
		...
		public void TrackProcessFlow(string name, Uri url, string processFlowStepType, string processFlowStepName, string processFlowHost, string userId, TimeSpan duration, string responseCode, bool wasSuccessfull, string sequence = null, IDictionary<string, string> properties = null, string sessionId = null)
		{
			...
			pageViewTelemetry.Properties.Add("processStepType", processFlowStepType);
			pageViewTelemetry.Properties.Add("processStepName", processFlowStepName);
			pageViewTelemetry.Properties.Add("processHost", processFlowHost);
